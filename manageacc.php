...
<div class="home-section">
					...
					while ($row = mysqli_fetch_assoc($result)){
						...
						echo "<td>
							<form method='POST'>
								...
								<input type='submit' class='btn btn-danger' value='delete' name='delete' style ='width: 90px;' onclick='window.location.reload()'>					
							</form>
							</td>";
						echo "</tr>";
					}
	...
	<div class = "create " id="creatediv">
		...
		<legend><b><i>Account Information</i></b></legend><br>
		<form method = "POST" action = "manageacc.php"> 	
			<div class="input-group input-group-sm mb-3">
				<div class="input-group-prepend">
					<span class="input-group-text" id="inputGroup-sizing-sm">Full Name:</span>
				</div>
				<input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" name="fullname" placeholder="Enter the full name..." required tabIndex="1" autofocus >
			</div>
			<div class="input-group input-group-sm mb-3">
				<div class="input-group-prepend">
